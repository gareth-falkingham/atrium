...
namespace Const
{
	...
	static const float PLAYER_ACCELERATION = 300.0f;
	//static const float PLAYER_DECELERATION = 10.0f;
	static const float PLAYER_MAX_SPEED = 200.0f;
	static const float PLAYER_MIN_INTERACTION_TIME = 2.0f;
	static const float PLAYER_MIN_INTERACTION_DISTANCE=100.0f;
